...
import { Package, Tags, FileText, Plus } from "lucide-react";
      ...
      <div className="flex-1 space-y-4 p-4 pt-6">
        ...
        <Tabs defaultValue="overview" className="space-y-4">
          <TabsList>
            ...
            <TabsTrigger value="products" className="hidden md:inline-flex">Products</TabsTrigger>
            <TabsTrigger value="categories" className="hidden md:inline-flex">Categories</TabsTrigger>
